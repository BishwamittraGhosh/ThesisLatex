...
\end{minipage}%
	...
	\begin{figure*}[!tbp]
		  ...
		  \end{minipage}
		  \begin{minipage}[b]{0.33\textwidth}
		    \scalebox{.5}{\input{time_n_vs_all_small_c=2.tex}}
		    \caption{$ <c=2, d_m=10> $}
		   \end{minipage}   	 
		  \begin{minipage}[b]{0.33\textwidth}
		  	   \scalebox{.5}{\input{time_d_vs_all_node_n=5,c=2.tex}}
		  	   		\caption{$<n'=5, c=2 >$}
		  \end{minipage}
		  
		  \vspace{.2cm}
		  	  \begin{minipage}[b]{0.33\textwidth}
		  	  \scalebox{.5}{\input{d_vs_all_node_n=5,c=2.tex}}
		  	  			\caption{  $<n'=5, c=2> $} 	
		  	   		
		  	  \end{minipage}
		  	  \begin{minipage}[b]{0.33\textwidth}
		  	 		\scalebox{.5}{\input{c_vs_all_small_n=5.tex}}
		  	 			\caption{$<n'=5, d_m=10> $}
		  	 	  \end{minipage}   	 
		  	  \begin{minipage}[b]{0.33\textwidth}
		  	  	   \scalebox{.5}{\input{time_c_vs_all_small_n=5.tex}}
		  	  	   	\caption{$<n'=5, d_m=10> $}
		  	  \end{minipage}
		...
		\end{figure*}
			...
			\begin{figure*}[!tbp]
				  %\centering
				  \begin{minipage}[b]{0.33\textwidth}
				   \scalebox{.5}{\input{b_n_vs_all_c=1.tex}}
				   	\caption{$<c=1, d_m=7> $}	
				   		
				  \end{minipage}
				  \begin{minipage}[b]{0.33\textwidth}
				   \scalebox{.5}{\input{time_b_n_vs_all_c=1.tex}}			  	\caption{ $<c=1, d_m=7> $}
				   \end{minipage}   	 
				  \begin{minipage}[b]{0.33\textwidth}
				  	  \scalebox{.5}{\input{b_d_vs_all,n=6,c=3.tex}}
				  	  \caption{ $<n'=6, c=3> $}
				  \end{minipage}
				  
				  \vspace{.2cm}
				  	  \begin{minipage}[b]{0.33\textwidth}
				  	 \scalebox{.5}{\input{time_b_d_vs_all,n=6,c=3.tex}}
				  		\caption{ $<n'=6, c=3> $}  		
				  	  \end{minipage}
				  	  \begin{minipage}[b]{0.33\textwidth}
				  	 		\scalebox{.5}{\input{b_c_vs_all_n=6.tex}}
				  	 		\caption{$<n'=6, d_m=7> $}
				  	 	  \end{minipage}   	 
				  	  \begin{minipage}[b]{0.33\textwidth}
				  	  	   \scalebox{.5}{\input{time_b_c_vs_all_n=6.tex}}
				  	  	   	\caption{ $<n'=6, d_m=7> $}
				  	  \end{minipage}
				 \caption{Bright kite Dataset}
				\end{figure*}
